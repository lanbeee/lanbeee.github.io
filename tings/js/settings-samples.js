...
function sortSampleHabit(name,type,target,logs,options = {}){
  ...
  const raw = {
    ...
    earlyWindowDays:clampFlexibility(options.earlyWindowDays != null ? options.earlyWindowDays : options.flexibilityDays),
    delayAllowanceDays:clampDelayAllowance(options.delayAllowanceDays),
    flexibilityDays:clampFlexibility(options.earlyWindowDays != null ? options.earlyWindowDays : options.flexibilityDays),
